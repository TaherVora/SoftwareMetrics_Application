...
from pyui.tcf_dialog import Ui_Dialog


class TcfDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        super(TcfDialog, self).__init__()
        self.ui = Ui_Dialog()
        ...
        try:
            ...
            for i in range(1, self.ui.gridLayout.rowCount() - 1):
                try:
                    ...
                    pass
            self.parent.ui.label_tcp_result.setText(str(total_sum))
    ...
    def save(self):
        ...
        self.parent.parent.project_data_dict[self.parent.parent.file_new_project_dialog.project_name]["UCP"][
            self.parent.ucp_filename]["tcf"] = self.adj_value_dict
