...
from pyui.uaw_dialog import Ui_Dialog


class UawDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        super(UawDialog, self).__init__()
        self.ui = Ui_Dialog()
        ...
        try:
            ...
            for i in range(1, self.ui.gridLayout.rowCount() - 1):
                try:
                    ...
                    pass
            self.parent.ui.label_uaw_result.setText(str(total_sum))
    ...
    def save(self):
        ...
        self.parent.parent.project_data_dict[self.parent.parent.file_new_project_dialog.project_name]["UCP"][
            self.parent.ucp_filename]["uaw"] = self.adj_value_dict
